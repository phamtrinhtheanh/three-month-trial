    ...
    @push('js')
        ...
        .nice-select .list {
            ...
            function submitOrders() {
                ...
                var form2 = $('.apply-coupon-form');
                var couponCode = form2.find('input[name="coupon_code"]').val();
                ...
                if (couponCode) {
                    $.ajax({
                        ...
                        success: function(response) {
                            processOrders(response.coupon_id);
                        },
                        error: function(error) {
                            toastr.error("Error fetching coupon ID:", error);
                            processOrders(null);
                        }
                    });
                } else {
                ...
                function processOrders(couponId) {
